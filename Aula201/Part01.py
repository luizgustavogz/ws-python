...
# - Qt é uma biblioteca usada para a criação de GUI (interface gráfica do
# usuário) escrita em C++.
...
# comerciais, sem ter que compartilhar o código escrito por você para o público.
# Licenças são tópicos complexos, portanto, se oriente sobre elas antes de usar
