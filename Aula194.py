...
# subprocess é um módulo do Python para executar processos e comandos externos
# no seu programa.
...
# automaticamente codificadas ou decodificadas com o conjunto de caracteres
# padrão da plataforma (geralmente UTF-8);
#   -> shell: Se True, terá acesso ao shell do sistema. Ao usar shell (True),
# recomendo enviar o comando e os argumentos juntos;
#   -> executable: pode ser usado para especificar o caminho do executável
# que iniciará o subprocesso.
#
# Retorno:
# stdout, stderr, returncode e args
# Importante: a codificação de caracteres do Windows pode ser diferente.
# Tente usar cp1252, cp852, cp850 (ou outros). Linux e mac, use utf_8.
# Comando de exemplo:
...
# print('Stdout:', proc.stdout.decode('cp852'))
