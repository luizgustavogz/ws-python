...
# Elas podem forçar outras classes a criarem métodos concretos. Também podem
# ter métodos concretor por elas mesmas.
# @abstractmethods são métodos que não tem corpo.
# As regras para classes abstratas com métodos abstratos é que elas NÃO PODEM
# ser instânciadas diretamente.
# Métodos anstratos DEVEM ser implementados nas subclasses (@abstractmethod).
