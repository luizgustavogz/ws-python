...
def formata_tamanho(tamanho_em_bytes: int, base: int = 1000) -> str:
    ...
    # math.log vai retornar o logaritmo do tamanho_em_bytes com a base
    # (1000 por padrão), isso deve bater com o nosso índice na abreviação dos tamanhos
...
for root, dirs, files in os.walk(path):
    ...
    for file_ in files:
        ...
        # tamanho = os.path.getsize(path_folder)
        stats = os.stat(path_folder)
